...
def upgrade() -> None:
    ...
    sa.Column('status', sa.Enum('PLANNING', 'IN_PROGRESS', 'COMPLETED', name='projectstatus'), nullable=False),
    sa.Column('project_owner', sa.Integer(), nullable=False),
    sa.ForeignKeyConstraint(['project_owner'], ['users.user_id'], ),
    ...
    sa.Column('project_id', sa.Integer(), nullable=False),
    sa.Column('user_id', sa.Integer(), nullable=False),
    sa.Column('role', sa.Enum('OWNER', 'COLLABORATOR', 'VIEWER', name='projectroleenum'), nullable=False),
